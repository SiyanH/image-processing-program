...
public class Image {
   ...
   * @throws IllegalArgumentException if the given RGB matrix is null or empty, or the RGB values
   *                                  are out of bound
   */
  ...
  /**
   * Check whether the given RGB matrix is valid (i.e., the RGB matrix is not empty and the values
   * are all within the 0-255 range). Return true if so, false otherwise.
   *
